...
- 🎓 Final Year Information Technology Student from Pune, India 🇮🇳  
- 🛠️ Building **Data-Powered AI Tools** & full-stack projects  
- 🌍 Dreaming big: Germany 🇩🇪 & Dubai 🇦🇪 bound  
- 💡 Passionate about **Data Science**, **AI**, and **Open Source**
...
- **FinMate** – An all-in-one financial tracker with NLP-powered chatbot and real-time visual analytics.
- **VoxMate** – Private ChatGPT-style assistant using Ollama + Streamlit, running fully on-premise.
- **DashFleet** – Live vehicle telematics dashboard for transport businesses (KIRAYA future extension).
...
<p align="center">
  ...
  &nbsp;
  <img src="https://streamlit.io/images/brand/streamlit-mark-color.svg" height="60" alt="Streamlit"/>
  &nbsp;
